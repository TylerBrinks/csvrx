...
var queries = new List<string>
{
    ...
    "SELECT C1, c1 FROM mycsv",
    //"SELECT * from (select c1, c2, c3 from test_a)",

    //"SELECT test_a.c1, test_a.c2, test_a.c3, test_b.c1, test_b.c2, test_b.c3 FROM test_a join test_b on test_a.c1 = test_b.c1 and test_b.c3 != test_a.c3",
    //"SELECT test_a.c1, test_a.c2, test_a.c3, test_b.c1, test_b.c2, test_b.c3 FROM test_a join test_b on test_a.c1 = test_b.c1",
